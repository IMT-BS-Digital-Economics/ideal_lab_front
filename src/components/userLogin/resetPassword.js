                  ...
                  <Stack spacing={6}>
                      ...
                      <FormControl>
                          <FormLabel>Email</FormLabel>
                              ...
                              />
                              <FormHelperText>Enter your email address linked to your account</FormHelperText>
                          </FormControl>
                          <Center marginTop={"2%"}>
                              <Fade in={!!email}>
                                  <Button
              ...
              <Center margin={"10%"}>
                  <Stack>
                      ...
                      <Center>
                          <Popover>
                              <PopoverTrigger>
                                  <Button leftIcon={<FcAbout/>} size="lg" iconSpacing={false}/>
                              </PopoverTrigger>
                              <PopoverContent>
                                  <PopoverArrow/>
                                  <PopoverCloseButton/>
                                  <PopoverBody>
                                      <Text margin={"2%"}>
                                          If you have an email address linked to an account, you will get soon a mail to reset your password
                                      </Text>
                                  </PopoverBody>
                              </PopoverContent>
                          </Popover>
