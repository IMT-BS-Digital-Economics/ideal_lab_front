            ...
            <Container maxW="container.xl" py={10}>
                <VStack spacing={5} textAlign="center" mb={10}>
                    ...
                    <Text fontSize="xl" color="teal.200">
                        A platform where research meets innovation. Manage
                        projects and gather global data efficiently.
                    </Text>
                </VStack>
                ...
                <Box bg="teal" borderRadius="lg" p={5} mb={10}>
                    ...
                    <Text color={'teal.100'}>
                        Dedicated to advancing privacy research, the Ideal Lab
                        Dashboard enables our team to harness data from various
                        platforms such as Facebook, Google, and TikTok. Based in
                        Paris-Saclay, France, our work focuses on the
                        intricacies of user privacy in daily habits.
                    </Text>
                </Box>
